...
export default function CategoriesSection() {
  ...
  if (isLoading) {
    return (
      <div className="w-full bg-linear-to-r from-amber-50 via-orange-50 to-red-50 border-t border-b border-slate-100">
            ...
            <Link key={category} href={`/?category=${category}`}>
              <div className="group cursor-pointer h-full">
                <div className="flex flex-col items-center justify-center gap-2 xs:gap-3 p-3 xs:p-4 sm:p-5 rounded-xl bg-white border border-slate-200 hover:border-orange-400 hover:bg-orange-50 transition-all duration-300 hover:shadow-lg hover:scale-105 h-full">
                  <div className="w-12 xs:w-14 sm:w-16 h-12 xs:h-14 sm:h-16 rounded-lg bg-linear-to-br from-orange-100 to-amber-100 flex items-center justify-center text-orange-600 group-hover:text-orange-700 group-hover:from-orange-200 group-hover:to-amber-200 transition-all duration-300">
